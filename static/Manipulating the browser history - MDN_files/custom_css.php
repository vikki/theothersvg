/* 
	cache-developer.mozilla.org.10.1.1-bb7b5cf926b4d8c52abcfa516c485b0d (8,128)
 */

/* --------- CACHE-DEVELOPER.MOZILLA.ORG.10.1.1-BB7B5CF926B4D8C52ABCFA516C485B0D --------- */
.cssprop {
	display:table;
	padding: 0.4em;
...
.geckoVersionHeading a:visited {
  color: #eeeeee;
}
.geckoVersionHeading a:link {
  color: #dddddd;
}
.geckoVersionHeading a:active {
  color: #ffdddd;
}

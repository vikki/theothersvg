...
/* @Header *********/
#masthead { background: #000 url("img/bg-pinstripe.png") center top repeat-x; border-top: 2px solid #fff; border-bottom: 4px solid #fb9500; color: #ccc; min-height: 70px; -moz-box-shadow: 0 1px 0 rgba(0,0,0,.25); -webkit-box-shadow: 0 1px 0 rgba(0,0,0,.25); box-shadow: 0 1px 0 rgba(0,0,0,.25); }
...
.global-notice { position: relative; border: solid #3c0000; border-width: 3px 0; background: #450000 url("img/bg-check-lt.png"); padding: 10px 20px; margin: 0 0 -1px; font-size: .857em; }
...
.browserid-info h3:after {
  ...
  height: 25px;
  margin: 0 -4px;
  background: transparent url("img/nav-arrows.png") 280px -1186px no-repeat;
